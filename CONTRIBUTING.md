...
1. Make an [Issue](https://github.com/ligofff/odin-continuous-group-attribute/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.odin-continuous-group-attribute": "https://github.com/YOUR_USER/odin-continuous-group-attribute.git"
        }
    }
```
